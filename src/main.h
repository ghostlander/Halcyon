...
static const int64_t BLOCK_LIMITER_TIME = 180;
...
static const uint256 hashGenesisBlockTestNet("0x9a9e20c1cc8dc1297fc4842e1b358a576db6c985f6dc4a6b8cf16f36f69aa54d");

/* Max. past time allowance for a new block */
inline int64_t PastDrift(int64_t nTime)   { return(nTime - 10 * 60); }
/* Max. future time allowance for a new block */
...
extern uint nStakeMaxAgeOne;
extern uint nStakeMaxAgeTwo;
...
uint GetNextTargetRequired(const CBlockIndex* pindexLast, bool fProofOfStake, bool fPrettyPrint = false);
